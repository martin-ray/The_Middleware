...
std::string filename = "/scratch/aoyagir/step1_500.h5";

/*
g++ refactor_test.cpp -I/usr/include/hdf5/serial -L/usr/lib/x86_64-linux-gnu/hdf5/serial/ -lhdf5 -lzstd -lmgard -lprotobuf
*/
...
int main() {
    ...
    long long int NumElements = offset_1*offset_2*offset_3*offset_4*offset_5;
