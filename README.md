...
## 1/11のTODO
- [x] ポスターを完成させる
- [ ] Fp16との勝負を解決させて、もうおしまいにする。モデル化してね。
- [ ] 余裕があったら、プログラムのリファクタリングをしてください。特に、L1周り。
- [ ] GPU二つで走らせて、ベンチマークを取ろう。いつものやつでね。で、明日のローカルゼミに持っていけるように
- [ ] ネットワークのレイテンシーを変えてやってみる？？やってみようか。それはすごく面白いと思います。

## 1/11のTODO

## 1/12のTODO
- [ ] 動画を撮影して、投稿してしまおう。これは、もう午前中に撮影してしまって、さっさと出したいよね。
- [ ] 健康診断に行こうたしか、13:00 - 15:00くらいかな。
- [ ] ローカルゼミに出よう。新しい内容としては、複数GPUでやった時の結果。vsFP16。んで、今後の予定を簡単に考えて、
